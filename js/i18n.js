...
const TRANSLATIONS = {
  ...
  'footer.copy':      { es: '© 2026 N0xFIX3R // ST3G4N05 // JMuRu — BASE DE CONOCIMIENTO DEF/OFENSIVA', en: '© 2026 N0xFIX3R // ST3G4N05 // JMuRu — A VAULT OF DEF/OFFENSIVE KNOWLEDGE' },

  /* ─── INDEX ─── */
  'index.hero.tag':   { es: '<span>ST3G4N05 // JORDI MURU a.k.a N0xFix3r // INCIDENT RESPONSE</span>', en: '<span>ST3G4N05 // JORDI MURU a.k.a N0xFix3r // INCIDENT RESPONSE</span>' },
  ...
  'index.sec2':       { es: 'ÚLTIMOS', en: 'RECENT' },
  ...
  /* ─── RED TEAM ─── */
  'rt.hero.tag':      { es: 'ATAQUE // EXPLOTACIÓN // POST-EXP', en: 'ATTACK // EXPLOITATION // POST-EXP' },
  'rt.hero.h1':       { es: 'OPERACIONES', en: 'OPERATIONS' },
  'rt.hero.sub':      { es: 'Metodologías ofensivas, explotación de vulnerabilidades, evasión de defensas y técnicas de post-explotación para profesionales de seguridad.', en: 'Offensive methodologies, vulnerability exploitation, defense evasion and post-exploitation techniques for security professionals.' },
  'rt.disclaimer':    { es: '⚠ AVISO LEGAL // El contenido de esta sección es solo para fines educativos y entornos autorizados. El uso de estas técnicas sin permiso explícito es ilegal.', en: '⚠ DISCLAIMER // The content in this section is for educational purposes and authorized environments only. Using these techniques without explicit permission is illegal.' },
  'rt.sec1.title':    { es: 'MÓDULOS', en: 'OFFENSIVE' },
  'rt.sec1.span':     { es: 'OFENSIVOS', en: 'MODULES' },
  'rt.sec2.title':    { es: 'WRITEUPS', en: 'WRITEUPS' },
  'rt.sec2.span':     { es: 'RED TEAM', en: 'RED TEAM' },
  'rt.btn.all':       { es: '// TODOS LOS POSTS RED TEAM', en: '// ALL RED TEAM POSTS' },
  'rt.mod.recon.tag':       { es: 'RECONOCIMIENTO', en: 'RECONNAISSANCE' },
  'rt.mod.recon.title':     { es: 'RECON &amp; OSINT', en: 'RECON &amp; OSINT' },
  'rt.mod.recon.desc':      { es: 'Recopilación de información pasiva y activa. Enumeración de subdominios, emails, tecnologías y mapeo de superficie de ataque externa.', en: 'Passive and active information gathering. Subdomain, email, technology enumeration and external attack surface mapping.' },
  'rt.mod.exp.tag':         { es: 'EXPLOTACIÓN', en: 'EXPLOITATION' },
  'rt.mod.exp.title':       { es: 'EXPLOTACIÓN', en: 'EXPLOITATION' },
  'rt.mod.exp.desc':        { es: 'Explotación de vulnerabilidades web (OWASP Top 10), servicios de red, aplicaciones y sistemas operativos con Metasploit y exploits propios.', en: 'Web vulnerability exploitation (OWASP Top 10), network services, applications and operating systems with Metasploit and custom exploits.' },
  'rt.mod.post.tag':        { es: 'POST-EXPLOTACIÓN', en: 'POST-EXPLOITATION' },
  'rt.mod.post.title':      { es: 'POST-EXPLOTACIÓN', en: 'POST-EXPLOITATION' },
  'rt.mod.post.desc':       { es: 'Persistencia, escalada de privilegios, movimiento lateral, volcado de credenciales y exfiltración de datos en entornos comprometidos.', en: 'Persistence, privilege escalation, lateral movement, credential dumping and data exfiltration in compromised environments.' },
  'rt.mod.privesc.tag':     { es: 'ESCALADA DE PRIVILEGIOS', en: 'PRIVILEGE ESCALATION' },
  'rt.mod.privesc.title':   { es: 'PRIVESC', en: 'PRIVESC' },
  'rt.mod.privesc.desc':    { es: 'Técnicas de escalada de privilegios en Linux y Windows. SUID, cron jobs, token impersonation, DLL hijacking y más vectores.', en: 'Privilege escalation techniques on Linux and Windows. SUID, cron jobs, token impersonation, DLL hijacking and more vectors.' },
  'rt.mod.c2.tag':          { es: 'INFRAESTRUCTURA C2', en: 'C2 INFRASTRUCTURE' },
  'rt.mod.c2.title':        { es: 'INFRA C2', en: 'C2 INFRA' },
  'rt.mod.c2.desc':         { es: 'Configuración y gestión de infraestructura de Comando y Control. Redirectores, domain fronting, OPSEC y comunicaciones encubiertas.', en: 'Setup and management of Command &amp; Control infrastructure. Redirectors, domain fronting, OPSEC and covert communications.' },
  'rt.mod.evasion.tag':     { es: 'EVASIÓN AV/EDR', en: 'AV/EDR EVASION' },
  'rt.mod.evasion.title':   { es: 'EVASIÓN', en: 'EVASION' },
  'rt.mod.evasion.desc':    { es: 'Técnicas para evadir antivirus, EDR y soluciones de seguridad. Ofuscación, packing, inyección de procesos y bypass de AMSI.', en: 'Techniques to evade antivirus, EDR and security solutions. Obfuscation, packing, process injection and AMSI bypass.' },

  /* ─── RESOURCES ─── */
  'rc.hero.tag':      { es: 'ARSENAL // HERRAMIENTAS // CHEATSHEETS', en: 'ARSENAL // TOOLS // CHEATSHEETS' },
  'rc.hero.h1a':      { es: 'ARSENAL', en: 'ARSENAL' },
  'rc.hero.h1b':      { es: 'RECURSOS', en: 'RESOURCES' },
  'rc.hero.sub':      { es: 'Herramientas, cheatsheets, wordlists y referencias rápidas para operaciones de ciberseguridad ofensivas y defensivas.', en: 'Curated tools, cheatsheets, wordlists and quick references for offensive and defensive cybersecurity operations.' },
  'rc.sec1.span':     { es: 'SHEETS', en: 'SHEETS' },
  'rc.sec2.title':    { es: 'HERRAMIENTAS', en: 'ESSENTIAL' },
  'rc.sec2.span':     { es: 'ESENCIALES', en: 'TOOLS' },
  'rc.sec3.title':    { es: 'POSTS', en: 'POSTS' },
  'rc.sec3.span':     { es: 'RECURSOS', en: 'RESOURCES' },
  'rc.btn.all':       { es: '// TODOS LOS POSTS DE RECURSOS', en: '// ALL RESOURCE POSTS' },
  'rc.mod.linux.title':    { es: 'COMANDOS LINUX', en: 'LINUX COMMANDS' },
  'rc.mod.linux.desc':     { es: 'Comandos Linux esenciales para pentesters: navegación, permisos, red, procesos, búsqueda de archivos y one-liners útiles.', en: 'Essential Linux commands for pentesters: navigation, permissions, network, processes, file search and useful one-liners.' },
  'rc.mod.win.title':      { es: 'WINDOWS CMD / PS', en: 'WINDOWS CMD / PS' },
  'rc.mod.win.desc':       { es: 'Comandos CMD y PowerShell para reconocimiento interno, gestión de usuarios, servicios y enumeración de entornos Windows/AD.', en: 'CMD and PowerShell commands for internal recon, user management, services and Windows/AD environment enumeration.' },
  'rc.mod.net.title':      { es: 'CHEATSHEET DE RED', en: 'NETWORK CHEATSHEET' },
  'rc.mod.net.desc':       { es: 'Herramientas de red: nmap, netcat, tcpdump, iptables, ss, dig y más. Con ejemplos de uso y los flags más comunes.', en: 'Network tools: nmap, netcat, tcpdump, iptables, ss, dig and more. With usage examples and most common flags.' },
  'rc.mod.web.title':      { es: 'EXPLOTACIÓN WEB', en: 'WEB EXPLOITATION' },
  'rc.mod.web.desc':       { es: 'Payloads de SQLi, XSS, SSRF, XXE, LFI/RFI y SSTI. Referencia rápida para testing de aplicaciones web y APIs.', en: 'SQLi, XSS, SSRF, XXE, LFI/RFI and SSTI payloads. Quick reference for web application and API testing.' },
  'rc.mod.revshell.title': { es: 'REVERSE SHELLS', en: 'REVERSE SHELLS' },
  'rc.mod.revshell.desc':  { es: 'Colección de reverse shells en bash, Python, PHP, Perl, PowerShell y más. Incluye one-liners y shells estabilizadas.', en: 'Collection of reverse shells in bash, Python, PHP, Perl, PowerShell and more. Includes one-liners and stabilized shells.' },
  'rc.mod.wordlists.title':{ es: 'WORDLISTS &amp; ROCKYOU', en: 'WORDLISTS &amp; ROCKYOU' },
  'rc.mod.wordlists.desc': { es: 'Las mejores wordlists para fuerza bruta y fuzzing: SecLists, RockYou, dirbuster. Cómo generarlas y cuándo usarlas.', en: 'Best wordlists for brute force and fuzzing: SecLists, RockYou, dirbuster. How to generate them and when to use them.' },
  'rc.tbl.tool':      { es: 'HERRAMIENTA', en: 'TOOL' },
  'rc.tbl.cat':       { es: 'CATEGORÍA', en: 'CATEGORY' },
  'rc.tbl.use':       { es: 'USO', en: 'USE' },
  'rc.tbl.nmap':      { es: 'Escaneo de puertos y detección de servicios', en: 'Port scanning and service detection' },
  'rc.tbl.burp':      { es: 'Interceptación y manipulación de tráfico HTTP', en: 'HTTP traffic interception and manipulation' },
  'rc.tbl.msf':       { es: 'Framework de explotación de vulnerabilidades', en: 'Vulnerability exploitation framework' },
  'rc.tbl.bh':        { es: 'Análisis de rutas de ataque en Active Directory', en: 'Attack path analysis in Active Directory' },
  'rc.tbl.vol':       { es: 'Análisis forense de volcados de memoria RAM', en: 'Forensic analysis of RAM memory dumps' },
  'rc.tbl.ws':        { es: 'Captura y análisis de tráfico de red', en: 'Network traffic capture and analysis' },
  'rc.tbl.ffuf':      { es: 'Fuzzer web ultrarrápido para directorios y parámetros', en: 'Ultra-fast web fuzzer for directories and parameters' },
  'rc.tbl.imp':       { es: 'Suite Python para ataques sobre protocolos SMB/Kerberos', en: 'Python suite for SMB/Kerberos protocol attacks' },
